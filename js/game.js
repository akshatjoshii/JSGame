var canvasBg = document.getElementById("canvasBg"),
    ...
    imgSprite = new Image();
imgSprite.src = "images/sprite3.png";
...
Player.prototype.enemyCollide = function() {
    for (var i = 0; i < enemies.length; i++) {
        if (collision(this, enemies[i])) {
          //  alert("Died");
            var soundEffect = new Audio("audio/player-reset.wav");
            died.style.display = "inline-block";
            soundEffect.play().then(function () {
                player1 = new Player();
...
Enemy.prototype.setTargetLocation = function () {
    this.randomMoveTime = randomRange(2000, 10000);
    var minX = this.centerX - 100,
        maxX = this.centerX + 100,
        minY = this.centerY - 100,
        maxY = this.centerY + 100;
    if (minX < 0) {
        minX = 0;
    }
    if (maxX > canvasWidth) {
...
Enemy.prototype.die = function () {
    ...
    this.srcX = 185;
    this.isDead = true;
    var enemyIndex = enemies.indexOf(this);
    var score = document.getElementById("scoreCount");
    var scoreCount = +score.innerHTML;
